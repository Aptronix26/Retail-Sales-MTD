...
assert.equal(sandbox.globalThis.PROD_DATASET_VERSION_2454, "aug2026-2026-08-26-v2459");
assert.equal(sandbox.globalThis.PROD_META_2454.achievementRows, 69);
assert.match(index, /daily-data\.js\?v=20260827-1/);
assert.ok(index.indexOf("daily-data.js?v=20260827-1") < index.indexOf("CLEAN PRODUCTION AUTH + DATA BOOTSTRAP"));
...
assert.match(index, /const DATASET_VERSION='aug2026-2026-08-26-v2459'/);

console.log("Daily MTD production data validated: 69 stores through 26 Aug 2026");
