...
assert.equal(total("iphoneTradeQty"), 2203);
assert.equal(total("macTradeQty"), 91);
assert.equal(total("iphoneLoanQty"), 2836);
assert.equal(total("overallLoanQty"), 3342);
assert.equal(total("iphoneProtectionQty"), 4439);
assert.equal(total("overallProtectionQty"), 7399);
assert.equal(total("microsoftQty"), 371);
assert.ok(Math.abs(total("lyRevenueSameDate") - 925048567.3) < 0.001);
assert.ok(Math.abs(total("lyRevenueFullMonth") - 1049293986.04) < 0.001);
assert.ok(Math.abs(actualTotal("revenue") - 1799912246.02) < 0.001);
...
assert.match(index, /commercial-data\.js\?v=20260826-1/);
assert.match(index, /commercial-levers\.js\?v=20260826-1/);
